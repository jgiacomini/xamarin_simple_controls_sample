...
namespace Sample.iOS.ViewControllers
{
    public class TextFieldViewController : UIViewController
    {
        ...
        private UILabel _labelStepper;

        public TextFieldViewController()
        {
			Title = "Saisir un texte, un nombre";
            ...
            _textField.TextColor = UIColor.Red;
            ...
            _textView.Layer.BorderColor = UIColor.Black.CGColor;

            _textView.AllowsEditingTextAttributes = true;
			_textView.Frame = new CGRect(10, 110, View.Bounds.Width - 20, 90);


            var width = 80;
            _stepper = new UIStepper();
            _stepper.Frame = new CGRect(View.Bounds.Width - 20 - width, 210, width, 40);
            _stepper.Value = 42;
			...
			_labelStepper.Frame = new CGRect(10, 210, View.Bounds.Width - 20, 40);
			_labelStepper.Text = _stepper.Value.ToString();

            View.AddSubviews(_textField, _passwordField, _textView, _stepper, _labelStepper);
